const researchDocs = [
  {
    ...
    "summary": "Power system operators require real-time situational awareness to maintain grid reliability during normal and emergency conditions. During grid emergencies, the operator decisionmaking process is always high-stakes.",
  ...
  },
  {
    ...
    "summary": "Accurate and reliable load forecasting is critical for power system planning, operations, and real-time decisionmaking. However, point forecasts fail to capture the uncertainty inherent in load forecasts under variable conditions.",
